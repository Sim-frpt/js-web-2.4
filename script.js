...
const getCharacters = async() => {
  try {
    const response = axios.get("https://character-database.becode.xyz/characters");
...
const displayCharacters = async() => {
  let charObject = await getCharacters();
  let charArray = charObject.data;
...
const displayModalContent = (arrayElement) => {
  ...
  description.innerText = arrayElement.description;
  ...
  modalContent.appendChild(shortDescription);
